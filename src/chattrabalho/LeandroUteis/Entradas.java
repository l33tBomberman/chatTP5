...
public class Entradas {
     ...
     * @param titulo Título que será exibido no diálogo.
     * @param mensagem Mensagem que será exibida no diálogo.
     * @param opcoes Array de strings com todas as opções que serão disponibilizadas
     * ao usuário.
     ...
     * @return Identificador referente à opção escolhida.
     * Ver <code>Entradas.OPCAO_SIM</code>, <code>Entradas.OPCAO_NAO</code>
     * e <code>Entradas.OPCAO_FECHAR</code>.
     */
     ...
     * @param mensagem Mensagem que será exibido no diálogo.
     * @return Identificador referente à opção escolhida.
     * Ver <code>Entradas.OPCAO_OK</code>, <code>Entradas.OPCAO_CANCELAR</code>
     * e <code>Entradas.OPCAO_FECHAR</code>.
     */
     ...
     * @return Identificador referente à opção escolhida.
     * Ver <code>Entradas.OPCAO_SIM</code>, <code>Entradas.OPCAO_NAO</code>,
     * <code>Entradas.OPCAO_CANCELAR</code> e <code>Entradas.OPCAO_FECHAR</code>.
     */
